...
import { analyzeRunBiomechanics } from '../src/tools/analyze-run.js';
import { GigaChatService } from '../src/gigachat/gigachat.service.js';
import { REAL_RUN_DATA } from '../tests/fixtures/real-data.js';
config();
async function main() {
...
main();
//# sourceMappingURL=direct-analysis.js.map